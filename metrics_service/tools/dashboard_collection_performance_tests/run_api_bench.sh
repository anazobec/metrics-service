...
# Usage:
#   AWX_DB_PASSWORD=password ./run_api_bench.sh

CONTAINER="automation-metrics-web"
FILL_SCRIPT="/tmp/fill_data.py"
BENCH_SCRIPT="/tmp/benchmark_dashboard_api.py"
...
# runs (see BENCHMARK_JENKINS_PODMAN_API.md — Security notes).
...
main()
" | tee /home/ansible/results_scale${SCALE}_api.txt
